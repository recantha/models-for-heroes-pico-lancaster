...
def Disable_motor():
    en1(0)  # motor 1 enable, set value 0 to disable
    en2(0)  # motor 2 enable, set value 0 to disable
...
while running:
    try:
        ...
        Motor_stop()
        utime.sleep(1) # Both motor in Stop position.
        Motor1_reverse()
        Motor2_reverse()
        utime.sleep(2) # Both motor in Reverse direction for 2 seconds.
        Motor_stop()
        utime.sleep(1) # Both motor in Reverse direction for 2 seconds.
